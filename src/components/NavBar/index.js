...
class NavBar extends Component {
  ...
  render() {
    ...
    const {searchRoute, isHome, isPopular, iscontactus, isAccount} = this.props
    ...
    const contactusRoute = iscontactus ? 'menu-items highlight' : 'menu-items'
      ...
      <nav className="nav-bar">
        <div className="header">
          ...
          <ul className="show-menu show1">
            ...
            <Link to="/contact" className={contactusRoute}>
              <li>ContactUs</li>
            </Link>
          </ul>
          <div className="icons-container">
            ...
            <Link to="/account">
              <img
                ...
                alt="profile"
                src="https://res.cloudinary.com/dlxu6eym2/image/upload/v1680528156/beautiful-blonde-woman-with-makeup-avatar-for-a-beauty-salon-illustration-in-the-cartoon-style-vector_cbvuml.jpg"
              />
            </Link>
            <button
